...
def main(args=None):	
    ...
    pub_command_twist = node.create_publisher(Twist, '/SousMarin/command/vel', 10)
    pub_command = node.create_publisher(Odometry, '/SousMarin/command/pos_vel', 10)
    ...
    try:
        ...
        while(1):
            ...
            odom.twist.twist.linear.x = x*speed
            odom.twist.twist.linear.y = y*speed
            odom.twist.twist.linear.z = z*speed
            odom.twist.twist.angular.x = 0.0
            odom.twist.twist.angular.x = 0.0
            odom.twist.twist.angular.x = th*turn
            
            pub_command_twist.publish(twist)
            pub_command.publish(odom)
